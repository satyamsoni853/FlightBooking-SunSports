    ...
    <div className="relative min-h-[90vh] flex items-center overflow-hidden bg-gray-50 dark:bg-black transition-colors duration-500">
      ...
      <div className="container mx-auto px-4 z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <motion.div
          ...
          className="space-y-8"
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/50 dark:bg-white/5 backdrop-blur-sm rounded-full border border-gray-200 dark:border-white/10 text-sm font-medium text-brand-blue dark:text-purple-300">
          ...
          <h1 className="text-5xl lg:text-7xl font-bold leading-tight text-brand-blue dark:text-white">
            Discover Your <br />
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link href="/flights/results">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-brand-blue dark:bg-white text-white dark:text-brand-blue rounded-full font-bold shadow-lg shadow-purple-500/20 flex items-center gap-2"
              >
            ...
            <Link href="/popular-routes">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-white/50 dark:bg-white/5 backdrop-blur-md border border-gray-200 dark:border-white/10 text-brand-blue dark:text-white rounded-full font-bold flex items-center gap-2 hover:bg-white dark:hover:bg-white/10 transition-colors"
              >
        ...
        >
          ...
          >
            <div className="relative w-full h-full">
              ...
              <Plane
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 text-brand-blue dark:text-white drop-shadow-2xl"
                strokeWidth={0.5}
              />
            </div>
          </motion.div>
